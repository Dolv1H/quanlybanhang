...
//     dinh nghia lai cac ham trong conio
...
{
    int tcode, valid ;
    char ch, t_itemcost[1000000000], t_itemprice[1000000000] ;
    tcode = last_code() ;
    tcode++ ;
    do
    {
        ...
        do
        {
            ...
            if (t_itemcost[0] == '0')
                return ;
            if (itemcost < 1000 || itemcost > 1000000000 )
            {
                valid = 0 ;
                gotoxy(3,24) ;
                cout <<"\7 Range = 1 000...1 000 000 000" ;
                getch() ;
            }
        }
        while (!valid) ;
        do
        {
            ...
            if (t_itemprice[0] == '0')
                return ;
            if (itemprice < itemcost || itemprice > 1000000000)
            {
                valid = 0 ;
                gotoxy(3,24) ;
                cout <<"\7 Range = " <<itemcost <<"..1 000 000 000" ;
                getch() ;
            }
        }
        while (!valid) ;
...
void product :: modify_record(int tcode)
{
    ...
    int valid, t_code ;
    char ch, t_itemcost[1000000000], t_itemprice[10000000000], t_itemcode[5] ;
    gotoxy(71,2) ;
    cout <<"<0>=Exit" ;
    gotoxy(5,12) ;
    cout <<"Item Code : " ;
    ...
    while (ch == 'Y' && !valid)
    {
        ...
        if (itemcost < 1000 || itemcost > 1000000000)
        {
            valid = 0 ;
            gotoxy(3,24) ;
            cout <<"\7 Range = 1000..1 000 000 000" ;
            getch() ;
        }
    }
    do
